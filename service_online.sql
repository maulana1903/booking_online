...
-- ----------------------------
-- Table structure for jadwal_karyawan
-- ----------------------------
...
CREATE TABLE `jadwal_karyawan`  (
  ...
  INDEX `foreign_id_karyawan`(`id_karyawan` ASC) USING BTREE,
  CONSTRAINT `foreign_id_karyawan` FOREIGN KEY (`id_karyawan`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of jadwal_karyawan
-- ----------------------------
INSERT INTO `jadwal_karyawan` VALUES (2, 4, '09:00:00', '2026-04-26');
INSERT INTO `jadwal_karyawan` VALUES (3, 4, '10:00:00', '2026-04-27');
...
INSERT INTO `service_online` VALUES (6, 'Haloo', 'Haloo', '2025-12-20', '10:25:00', 'https://www.google.com/maps?q=-7.708167859454443,110.83275765180589', 'Rusak', 'Kalibrasi1.png', 'Menunggu', '85641496254');
